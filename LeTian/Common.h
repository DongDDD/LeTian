...
//  聚宝门
//
//  Created by Chitat on 16/3/2.
//  Copyright © 2016年 Chitat. All rights reserved.
//
...
//{
//    CGRect rect;
//    rect.origin.x = kWidth(x);
//    rect.origin.y = kHeight(y);
//    rect.size.width = kWidth(width);
//    rect.size.height = kHeight(height);
//    return rect;
//}
...
#define klogoColor        kColor(213, 82, 74, 1);
